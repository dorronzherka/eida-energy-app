        ...
        return (
            ...
            <Container>
                <Row>
                    ...
                    <BoxInfo value={Math.ceil(parseFloat(location.daily_prod_KWH) * 7)} type='kWh' title='Total Production Week'/>
                    <BoxInfo value={location.monthly_prod_KWH != null ?  parseFloat(location.monthly_prod_KWH) : Math.ceil(parseFloat(location.daily_prod_KWH) * 30)} type='kWh' title='Total Production Month'/>
                    <BoxInfo value={location.yearly_prod_KWH != null ? parseFloat(location.yearly_prod_KWH) : Math.ceil(parseFloat(location.daily_prod_KWH) * 365)} type='kWh' title='Total Production Year '/>
                    <BoxInfo value={Math.floor(parseFloat(location.consumption_total) * daysLeftThisMonth)} type='kWh' title='Forecasted consumption'/>
                    <BoxInfo value={Math.ceil(parseFloat(location.daily_prod_KWH) * daysLeftThisMonth)} type='kWh' title='Forecasted production kwh'/>
